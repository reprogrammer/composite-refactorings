...
/**
 * Refactoring descriptor for the use super type refactoring on variable declarations and casts.
 * <p>
...
public final class UseSuperTypeInVariableDeclarationsDescriptor extends JavaRefactoringDescriptor {

	/**
	 * This ID should match the of the refactoring contribution used in the corresponding extension.
	 */
	public static final String ID= "edu.illinois.compositerefactorings.usesupertypeinvariabledeclarations";
	 ...
	 */
	public UseSuperTypeInVariableDeclarationsDescriptor() {
		super(ID);
	}
	 ...
	 * 
	 */
	public UseSuperTypeInVariableDeclarationsDescriptor(String project, String description, String comment, Map<String, String> arguments, int flags) {
